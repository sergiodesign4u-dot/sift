...
Full segment detail: [strategy.md](strategy.md) Section 2, [personas.md](../../research/docs/personas.md).
...
Primary JTBD: *When I have a roadmap planning session coming up, I want to see a trustworthy synthesis of what customers are saying, with evidence I can trace, so that I can make a confident, defensible prioritization call and not just guess.* ([jtbd.md](../../research/docs/jtbd.md))
